...
This a page to note Jest uni-test, will improve and prefect this page, and the first version is from [JUEJIN](https://juejin.cn/post/6844904095682134029)
## 引言
...
第一个测试(Enzyme)将通过，但第二个测试(RTL)将失败。实际上，第一个并不关心按钮是否正确地连接到方法。它只查看实现本身，也就是说，您的递增和递减方法执行之后，应用的状态是否正确。 这就是代码损坏，测试也会通过。
...
文档：[testing-library.com/docs/dom-te…](https://testing-library.com/docs/dom-testing-library/api-queries#queries)
...
更多例子请参考React Testing Library官方文档。
## 结语
